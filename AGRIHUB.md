...
- Anthropic Claude for clarification, planning, parallel research, compression,
  web search, and final report generation
...
Open <http://localhost:3000>. The UI is preconfigured to use the `agrihub`
graph at <http://localhost:2024>.
...
4. Run Anthropic web search and any configured MCP tools.
